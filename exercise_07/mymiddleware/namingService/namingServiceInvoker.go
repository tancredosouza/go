...
func (i *Invoker) Invoke() {
	...
	for {
		...
		go handleNewConnection(srh)
	}
}

func handleNewConnection(srh infrastructure.ServerRequestHandler) {
	for {
		receivedData, _ := infrastructure.Receive(srh.Conn)
		...
		infrastructure.Send(processedData, srh.Conn)
	}
}
